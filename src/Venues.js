...
import redfox from './images/redfox348x220.jpg';
import flickerbox from './images/flickerbox348x220.jpg';
  ...
  render() {
    return (
      <Grid className="featured">
          ...
          <Row>
            <Col lg={3} md={4} sm={6}>
                <img src={flickerbox} className="featuredImg" alt="flickerbox" />
                <h2>Flickerbox</h2>
            ...
            <Col lg={3} md={4} sm={6}>
                <img src={redfox} className="featuredImg" alt="redfox" />
                <h2>The Red Fox</h2>
